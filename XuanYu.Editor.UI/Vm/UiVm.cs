    ...
    XuanYu.Render.Abstractions.IRenderProjectionSource
{
        ...
        IEditorDialogService? dialogService = null)
    {
        ...
        SelectToolCommand = new RelayCommand(name => SelectTool(name?.ToString() ?? string.Empty)); SwitchWorkspaceCommand = new RelayCommand(SwitchWorkspace); SelectRegionAuthoringModeCommand = new RelayCommand(SelectRegionAuthoringModeCommandTarget);
        ...
        AttachMapSession(MapSession); InitializeMapManifest(); InitLogs();
    }
