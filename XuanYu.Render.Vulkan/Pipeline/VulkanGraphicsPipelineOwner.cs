...
internal sealed unsafe class VulkanGraphicsPipelineOwner : IDisposable
{
    ...
    internal static VulkanGraphicsPipelineOwner? Create(Vk vk, VulkanDeviceOwner deviceOwner, VulkanClearFrameOwner clearFrame, VulkanSwapchainOwner swapchain, Action<string>? log)
    {
        ...
        fixed (byte* pName = entry)
        {
            ...
            var pipelineInfo = new GraphicsPipelineCreateInfo
            {
                ...
                PMultisampleState = &multisample, PDepthStencilState = &depth, PColorBlendState = &colorBlend, PDynamicState = &dynamicState,
    ...
    public void Dispose()
    {
        ...
        _pipeline = default; _layout = default; _log?.Invoke(VulkanPipelineLogFormatter.Disposed());
    }
}
