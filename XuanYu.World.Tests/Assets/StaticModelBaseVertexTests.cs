...
public sealed class StaticModelBaseVertexTests
{
    ...
    {
        var model = Import(GlbFactory.MultiPrimitive());
    ...
    {
        var model = Import(GlbFactory.ThreePrimitives());
    ...
    {
        var model = Import(GlbFactory.Triangle(indices: false));
    ...
    {
        var model = Import(GlbFactory.Triangle());
