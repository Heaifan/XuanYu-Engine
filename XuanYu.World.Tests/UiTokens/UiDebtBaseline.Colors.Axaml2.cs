...
internal static partial class UiDebtBaseline
{
    private static void AddAxaml2(System.Collections.Generic.List<BaselineEntry> list)
    {
        ...
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.xyui-toggle-button.toolBtn:pressed", UiRuleKind.HexColor, "Background", "#dfeaf8"));
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.xyui-toggle-button.toolBtn:checked", UiRuleKind.HexColor, "Background", "#eef5ff"));
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.xyui-toggle-button.toolBtn:checked", UiRuleKind.HexColor, "BorderBrush", "#94b9e8"));
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.xyui-toggle-button.toolBtn:checked", UiRuleKind.HexColor, "Foreground", "#185aa6"));
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:Path.topIcon", UiRuleKind.HexColor, "Stroke", "#5d6d83"));
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:Button.xyui-button.cmdBtn:pointerover Path.topIcon", UiRuleKind.HexColor, "Stroke", "#365d8d"));
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.xyui-toggle-button.toolBtn:pointerover Path.topIcon", UiRuleKind.HexColor, "Stroke", "#365d8d"));
        list.Add(new("W26", "XuanYu.Editor.UI/Top/Top.axaml", "Style:ToggleButton.xyui-toggle-button.toolBtn:checked Path.topIcon", UiRuleKind.HexColor, "Stroke", "#185aa6"));
