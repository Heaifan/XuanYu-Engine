...
public static partial class XYUI3LiveExamplesFactory
{
    ...
    {
        var board = XYUI3GalleryCatalog.ContextToolbarBoard(); var split = new XYSplitButton { Content = "道路", Height = 32, Width = 112 }; board.ActionExecuted += (_, action) => split.Content = action.Label; board.AttachTrigger(split); split.MenuCommand = new ContextBoardCommand(board, split);
