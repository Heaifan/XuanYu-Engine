...
public sealed class XYUI3GalleryNavigationTests : IClassFixture<XyuiHeadlessFixture>
{
    ...
    {
        XyuiBatchTestHost.Prepare(); var vm = new XYUI1DocumentationViewModel(); Assert.Equal(24, vm.XYUI3Items.Count); Assert.Equal("24/24", vm.XYUI3CountText); Assert.Equal("XYUI-3-3.24", vm.SelectedXYUI3Item?.Id);
    });
}
