...
public static partial class XyuiComponentStyles
{
    static void Batch05(Styles styles)
    {
        ...
        var danger = new Style(x => x.OfType<XYCommandItem>().Class("xyui-command-danger")); Brush(danger, Button.BackgroundProperty, Brushes.Transparent); Brush(danger, Button.ForegroundProperty, "XY.Brush.Semantic.Error.Text"); styles.Add(danger);
