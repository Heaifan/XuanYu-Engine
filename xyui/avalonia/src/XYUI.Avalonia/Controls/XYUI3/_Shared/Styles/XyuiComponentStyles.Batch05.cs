...
public static partial class XyuiComponentStyles
{
    static void Batch05(Styles styles)
    {
        ...
        var context = new Style(x => x.OfType<TextBlock>().Class("xyui-command-context")); context.Setters.Add(new Setter(TemplatedControl.FontSizeProperty, 10.5d)); Brush(context, TextBlock.ForegroundProperty, "XY.Brush.Text.Secondary"); styles.Add(context);
        var contextName = new Style(x => x.OfType<TextBlock>().Class("xyui-command-context-name")); contextName.Setters.Add(new Setter(TemplatedControl.FontSizeProperty, 12.5d)); contextName.Setters.Add(new Setter(TemplatedControl.FontWeightProperty, FontWeight.SemiBold)); styles.Add(contextName);
        var primary = new Style(x => x.OfType<XYCommandItem>().Class("xyui-command-primary")); Brush(primary, Button.BackgroundProperty, "XY.Brush.Accent.Soft"); Brush(primary, Button.ForegroundProperty, "XY.Brush.Accent.Strong"); primary.Setters.Add(new Setter(Button.CornerRadiusProperty, new CornerRadius(3))); styles.Add(primary);
        var primaryIcon = new Style(x => x.OfType<XYCommandItem>().Class("xyui-command-primary").Descendant().OfType<XYIcon>()); Brush(primaryIcon, XYIcon.StrokeProperty, "XY.Brush.Accent.Strong"); styles.Add(primaryIcon);
        var danger = new Style(x => x.OfType<XYCommandItem>().Class("xyui-command-danger")); danger.Setters.Add(new Setter(Button.BackgroundProperty, Brushes.Transparent)); Brush(danger, Button.ForegroundProperty, "XY.Brush.Semantic.Error.Text"); styles.Add(danger);
        var feedback = new Style(x => x.OfType<TextBlock>().Class("xyui-command-feedback")); feedback.Setters.Add(new Setter(TemplatedControl.FontSizeProperty, 11d)); Brush(feedback, TextBlock.ForegroundProperty, "XY.Brush.Text.Secondary"); styles.Add(feedback);
