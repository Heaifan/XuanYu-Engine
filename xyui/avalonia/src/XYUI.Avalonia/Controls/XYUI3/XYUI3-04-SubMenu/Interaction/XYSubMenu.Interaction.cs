...
public sealed partial class XYSubMenu
{
    ...
    public void Open() { if (IsOpen) return; IsOpen = true; ChildMenu.IsVisible = true; Opened?.Invoke(this, EventArgs.Empty); }
    public void Close() { if (!IsOpen) return; IsOpen = false; ChildMenu.IsVisible = false; Closed?.Invoke(this, EventArgs.Empty); }
