...
public sealed partial class XYNavigationItem : Border
{
    ...
    Grid CompactVisual() => new() { Children = { new Border { Classes = { "xyui-navigation-accent" } }, new XYIcon { Icon = Icon, Size = XyuiIconSize.Small, Classes = { "xyui-navigation-icon" }, HorizontalAlignment = HorizontalAlignment.Center, VerticalAlignment = VerticalAlignment.Center } } };
    Grid FullVisual() => new() { ColumnDefinitions = new ColumnDefinitions("3,Auto,*"), Children = { new Border { Classes = { "xyui-navigation-accent" } }, new XYIcon { Icon = Icon, Size = XyuiIconSize.Small, Classes = { "xyui-navigation-icon" }, [Grid.ColumnProperty] = 1 }, new TextBlock { Text = Label, Classes = { "xyui-navigation-label" }, [Grid.ColumnProperty] = 2, Margin = new Thickness(8, 0, 0, 0), VerticalAlignment = VerticalAlignment.Center } } };
}
