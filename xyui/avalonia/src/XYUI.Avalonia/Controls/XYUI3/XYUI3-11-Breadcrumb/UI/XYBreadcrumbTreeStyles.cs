...
public static partial class XyuiComponentStyles
{
    static void BreadcrumbTree(Styles styles)
    {
        ...
        var focused = new Style(x => x.OfType<XYTreeNode>().Class("xyui-tree-focused").Descendant().OfType<Border>().Class("xyui-tree-node-surface")); Brush(focused, Border.BorderBrushProperty, "XY.Brush.Accent.Default"); focused.Setters.Add(new Setter(Border.BorderThicknessProperty, new Thickness(1))); styles.Add(focused);
