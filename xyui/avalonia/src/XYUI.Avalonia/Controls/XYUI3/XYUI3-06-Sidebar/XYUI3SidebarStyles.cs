...
public static partial class XyuiComponentStyles
{
    static void SidebarRailTabs(Styles styles)
    {
        ...
        var selected = new Style(x => x.OfType<XYTab>().Class("xyui-tab-selected")); Brush(selected, Border.BackgroundProperty, "XY.Brush.Surface.Selected"); selected.Setters.Add(new Setter(Border.BorderBrushProperty, new SolidColorBrush(Colors.Transparent))); selected.Setters.Add(new Setter(Border.BorderThicknessProperty, new Thickness(0, 0, 0, 3))); selected.Setters.Add(new Setter(Border.PaddingProperty, new Thickness(10, 0, 10, 0))); styles.Add(selected);
