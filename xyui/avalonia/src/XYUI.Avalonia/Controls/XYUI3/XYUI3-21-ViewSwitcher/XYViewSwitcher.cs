...
public sealed partial class XYViewSwitcher : Border
{
    ...
    XYButton BuildTrigger()
    {
        ...
        var button = new XYButton { Height = 34, Width = 220, Variant = XyuiButtonVariant.Secondary, Classes = { "xyui-view-dropdown-trigger" }, Content = grid }; button.Click += (_, _) => Open(button); return button;
    }
