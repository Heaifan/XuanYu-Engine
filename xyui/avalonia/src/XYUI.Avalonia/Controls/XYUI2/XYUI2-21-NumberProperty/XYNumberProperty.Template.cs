...
public partial class XYNumberProperty
{
    internal static FuncControlTemplate<XYNumberProperty> CreateTemplate() => new((control, scope) =>
    {
        ...
        var field = new XYNumberField { Name = "PART_ValueField", Width = 180, Height = 30, IsScrubEnabled = true };
        var row = new Grid { Name = "PART_Row", Height = XYPropertyLayoutMetrics.RowHeight, ColumnDefinitions = new ColumnDefinitions("*,Auto"), Children = { label, field } };
        Grid.SetColumn(field, 1); control.LabelPart = label; control.LabelTextPart = text; control.ValueFieldPart = field;
    ...
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        ...
        base.OnApplyTemplate(e); LabelPart = e.NameScope.Find<Border>("PART_Label") ?? LabelPart; LabelTextPart = e.NameScope.Find<TextBlock>("PART_LabelText") ?? LabelTextPart; ValueFieldPart = e.NameScope.Find<XYNumberField>("PART_ValueField") ?? ValueFieldPart;
