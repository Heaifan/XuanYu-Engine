...
public static partial class XyuiControlStyles
{
    ...
    static void VectorProperty(Styles styles)
    {
        ...
        var host = new Style(x => x.OfType<XYVectorProperty>().Class("xyui-vector-property").Template().Name("PART_Axes").Descendant().Class("xyui-vector-axis-host")); Set(host, Border.BackgroundProperty, "XY.Brush.Surface.Input"); Set(host, Border.BorderBrushProperty, "XY.Brush.Border.Color.Default"); host.Setters.Add(new Setter(Border.BorderThicknessProperty, new Thickness(1))); host.Setters.Add(new Setter(Border.CornerRadiusProperty, new CornerRadius(6))); styles.Add(host);
    ...
    static void ReferenceProperty(Styles styles)
    {
        ...
        var field = new Style(x => x.OfType<XYReferenceProperty>().Class("xyui-reference-property").Template().Name("PART_ReferenceField")); Set(field, Border.BackgroundProperty, "XY.Brush.Surface.Panel"); Set(field, Border.BorderBrushProperty, "XY.Brush.Border.Color.Default"); field.Setters.Add(new Setter(Border.BorderThicknessProperty, new Thickness(1))); field.Setters.Add(new Setter(Border.CornerRadiusProperty, new CornerRadius(3))); styles.Add(field);
