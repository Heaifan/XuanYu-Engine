...
public partial class XYTextArea : XyuiEditableTextBox
{
    ...
    internal TextBlock? EditorMetadataPart { get; private set; }
    internal TextBlock? EditorModifiedPart { get; private set; }
    bool _layoutQueued;
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == EditorTypeProperty) UpdateEditorBar();
