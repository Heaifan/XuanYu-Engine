...
public partial class XYColorPicker
{
    ...
    protected override void OnDetachedFromVisualTree(VisualTreeAttachmentEventArgs e) { CancelEditLifecycle(); if (_applicationLifetime is not null) _applicationLifetime.Deactivated -= OnApplicationDeactivated; if (_hostWindow is not null) { _hostWindow.Deactivated -= OnWindowDeactivated; _hostWindow.Closed -= OnWindowClosed; } _applicationLifetime = null; _hostWindow = null; base.OnDetachedFromVisualTree(e); }
    void OnApplicationDeactivated(object? sender, ActivatedEventArgs e) => CancelEditLifecycle();
    void OnWindowDeactivated(object? sender, EventArgs e) => CancelEditLifecycle();
    void OnWindowClosed(object? sender, EventArgs e) => CancelEditLifecycle();
}
