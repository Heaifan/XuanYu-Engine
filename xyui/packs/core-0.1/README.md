...
> 状态：**`READY_FOR_XYLAB_PILOT`**（XYUI-0/1/2/3/4/5 全部 CLOSED；XYUI-6 canonical 完成，待用户验收）。
...
| XYUI-6 | Data & Collections（20 项） | CANONICAL_COMPLETE（待用户验收） | `xyui/specs/XYUI6/` |
