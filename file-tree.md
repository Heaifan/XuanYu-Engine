...
- `XuanYu.Editor.UI/Right/DatasetLayerPanel.axaml` — MAP-DOC-A-R2-F3：右侧 Dataset-backed Layer Projection 列表与选中态。
- `XuanYu.Editor.UI/Right/DatasetLayerPanel.axaml.cs` — MAP-DOC-A-R2-F3：右侧投影行点击转发 code-behind。
