...
- Shared SDK resolver and wrapper are now used by run.bat and documented in the sync handoff SOP.
- Verification: resolver contract PASS; solution build 0W0E; FeatureEdit 4/4; Core 339/339; WarCore 22/22; World 1515/1515; XYUI 617/617; ARCH-A and 5+100 PASS; diff-check PASS.
- Remaining: automated gates complete; real-device acceptance remains with the user.
