## v0.2.28.73-rz - TOOLCHAIN-DOTNET-R1 + FEATURE-EDIT-R1-C1-FIX1 (2026-09-12 22:20:00 +08:00)
- Goal: reset Feature Selection and Geometry Editing state on selection change and selection clear.
- Change: SelectMapGeometry and ClearMapGeometrySelection now reset IsGeometryEditingActive; added Marker-to-Road, Road-to-Region, and clear-selection regression tests.
- Change: added the shared SDK resolver, PowerShell wrapper, and run.bat integration; SOP now requires the shared toolchain authority.
- Verification: resolver contract PASS; solution build 0 warning / 0 error; FeatureEdit 4/4, Core 339/339, WarCore 22/22, World full PASS; ARCH-A PASS; 5+100 PASS; git diff --check PASS.
- Hash: final commit of this round.
- Remaining: none for automated gates; real-device acceptance remains with the user.

# changelog

## v0.2.28.73-rz - FEATURE-EDIT-R1-CODEX-C1 (2026-09-12 21:40:21 +08:00)
- Ŀ�꣺�����б༭�����������Ҫ�ر༭״̬�뼸�α༭״̬�տڡ�ѡ�����ʱ�����뼸�α༭����ʽִ�б༭���βŽ��롣
- �仯����ȫ����������ȱʧ����ʽ�������α༭ģʽ���߼����޸� FeatureEditWorkflowRuntimeTests ʹ֮�� Session �й�����Ч�ĵ�ͼҪ�ء��淶������ IsFeatureEditingActive �� IsGeometryEditingActive���Լ���Ӧ�� ToggleFeatureEditingCommand �� ToggleGeometryEditingCommand��
- ��֤���Զ����Բ����޸���arch-a-guard PASS��ȫ�� dotnet test ���� PASS��
- Hash��������
- ������UI չ�ֲ�Ķ����˵� ��Ҫ�ر༭ �� ����༭ ��Ȼ���ڣ�Gemini ���Ƴ��������� Gemini ���� �༭���� ��ڣ��Լ�������� UI �󶨡�
