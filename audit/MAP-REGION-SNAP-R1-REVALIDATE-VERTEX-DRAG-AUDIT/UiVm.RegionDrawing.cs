...
public sealed partial class UiVm
{
    ...
    public bool RegionDrawingPointerPressed(double x, double y, ViewportState viewport, bool snapSuppressed = false)
    {
        ...
        if (_regionDrawing.IsCloseCandidate || IsRegionClosePointer(x, y, viewport))
    ...
    public bool RegionDrawingPointerMoved(double x, double y, ViewportState viewport, bool snapSuppressed = false)
    {
