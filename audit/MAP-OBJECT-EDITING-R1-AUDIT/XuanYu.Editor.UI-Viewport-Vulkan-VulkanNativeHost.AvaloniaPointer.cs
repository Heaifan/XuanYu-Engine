...
public sealed partial class VulkanNativeHost
{
    ...
    protected override void OnPointerPressed(PointerPressedEventArgs e)
    {
        ...
        if (point.Properties.IsRightButtonPressed && vm.TryGetMapGeometryContext(point.Position.X, point.Position.Y,
            vm.CurrentViewport, out var hit)) ShowMapGeometryContextMenu(vm, hit, point.Position.X, point.Position.Y);
