...
| D5 | 状态/表单/菜单/弹窗/日志 | W36、W59、W68、G05、G08（**D5-FINAL 后 READY FOR USER RE-ACCEPTANCE**：地图状态四态（未落盘/未保存/已保存/有未保存修改）+ 全刷新点；弹窗去内部编号正式文案；D5-DEFER-01 地图持久化暂缓（独立专项，不归 D6）；G02 焦点系统完整化/自动消失策略留 D6） |
