...
| D5 | 状态/表单/菜单/弹窗/日志 | W36、W59、W68、G05、G08（**D5 纠偏后 READY FOR USER RE-ACCEPTANCE**：审查十项阻塞全部修复——危险 fail-closed、新建地图未保存三选、字段级校验、空态互斥、焦点合同 FocusAdorner、通知合并/关闭/优先级、场景重试、日志视觉 Token 化（基线 -21）、5+100 拆分、Inter 零残留；G02 焦点系统完整化/自动消失策略/地图持久化留 D6） |
