...
- F1 FINAL：11/15 PASS；M03/M04/M05 为 Grid 与 World Axis 共享的极远投影边界故障，先执行纯诊断 `F1-FAR-DIAG-01`；M06（四点 Region 闭合/图层删除）明确拆分为后续 `F1-REGION-CLOSE-01`，不得混修。F1 保持 `OPEN · FINAL ACCEPTANCE FAILED · 4 ITEMS REMAIN`。
