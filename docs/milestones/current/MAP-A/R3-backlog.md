...
- D2-F1：F1-C 稳定性与日志收口已完成，F1-V 矢量叠加尚未开始；不重复要求用户证明既有 S01/S02 失败事实。
- 当前重点：Draft 活跃或无选中实体时聚焦不得改变相机；F1TRACE 取证噪声已移除。
- D3：禁止启动。
- F2：不创建。
...
- F1-C 自动门禁通过后仍需用户确认 Focus 与日志行为；通过前继续保持 OPEN，不恢复 A03～A06。
