...
sealed unsafe class VulkanClearProbeDeviceSelector
{
    ...
    delegate Result SurfaceSupportPtr(Silk.NET.Vulkan.PhysicalDevice pd, uint qi, SurfaceKHR s, int* supported);
}
